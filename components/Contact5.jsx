...
const Contact5 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_4eykemc', 'template_0lbmcue', templateParams, 'i9qxA7r_HMe6RZA4y')
      .then(resp => {
  ...
  return (
    <div className="relative mx-auto w-full max-w-7xl bg-white text-gray-700" id='contacto'>
      <div className="grid grid-cols-2">
        
        {/* :MAP CONTAINER */}
        <div className="order-1 col-span-full">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3989.8183203087137!2d-78.45861319452526!3d0.0002380460500803974!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7204d0b38e698b6a!2s67G32G2R%2B8MP!5e0!3m2!1ses!2sec!4v1674448517947!5m2!1ses!2sec" 
        ...
        <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <form action="" className="mx-auto max-w-xl space-y-4" onSubmit={handleSubmit}>
            ...
            {/* ::Submit Button */}
            <div>
              <button type="submit" className="py-2 px-6 rounded bg-green-400 text-base text-white font-semibold uppercase hover:bg-green-500">Enviar mensaje</button>
            </div>
          </form>
        </div>
        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            {/* ::Title Contact Us */}
            <h2 className="text-4xl font-oswald uppercase">Contactanos</h2>
            {/* ::Email contact */}
            <a href="mailto:andi_david95@hotmail.com" className="inline-flex items-center text-sm text-blue-400 font-semibold hover:text-blue-500">
            ...
            <div className="flex items-center">
              ...
              {/* </a> */}
              {/* :FACEBOOK */}
              <a href="www.facebook.com" className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#4267B2] text-white filter hover:brightness-125" style={{ backgroundColor: "#4267B2" }}>
                {/* ::facebook svg */}
